...
#
#           V_14
#           Implement the generating of a plot 
#           
#
#           gpz6 - 1H - D = 6,05E-09
#           d20 = 0.1 s 
...
frame_plot = tk.LabelFrame(root, text="Graphical Results")
frame_plot.grid(row=1, column=0, padx=10, pady=10, sticky="n")
#plot_into_frame(frame_plot)  # calling the plot function, just as a placeholder
