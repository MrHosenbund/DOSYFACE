...
y = 2.51*10**8  #SI-unit: rad/s*T #gyromagnetic ratio C
gradient_length = (550/10**6)*2        # 1871.0000  us /// SI-unit: Sekunden / 10**6 In Sekunden - p30 Angabe in Mikrosekunden (usec)
t = 0.1  # SI-unit: In Sekunden: 100 ms 

sample_name=("C8_Strength-19F_14.5-Fit")
#
...
df_DOSY = import_data(r"Global_Diff\Integrale-LB-var\C8_19F_global_G_Strength_DOSY-100-115") #absolute path to dataH
...
plt.title(f"Residuals{sample_name}")
plt.xlabel("Gradient Strength / [Tm⁻¹]")
