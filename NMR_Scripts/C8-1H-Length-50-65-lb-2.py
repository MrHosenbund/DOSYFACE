...
y_gyro = 2.67*10**8 #SI-unit: rad/s*T #gyromagnetic ratio C
gradient_strength = 0.1205*0.593       #  us /// SI-unit: Sekunden / 10**6 In Sekunden - p30 Angabe in Mikrosekunden (usec)
t = 0.1  # SI-unit: In Sekunden: 100 ms 
sample_name = "C8_1H_Global_Length_-lb2-DOSY"
...
df_DOSY = import_data(r"C:\Users\bruno\Documents\Studium\MP_Kovermann\Processing\Global_Diff\Integrale-LB-2\C8-1H-L-50-65-LB-2") #absolute path to dataH
...
Fitted_Curve = ["1H - 4.13" ] # Fit Legend Beschriftung
...
ax.set_title("C8_1H_Length_Fit Lb 2")
...
save_dir = "Global_Diff/Integrale-LB-2"
...
ax.set_title("C8_1H_Length Residuals Lb 2")
ax.set_xlabel("Gradient Length / s")
ax.set_ylabel("Norm. Integral / a.u.")
