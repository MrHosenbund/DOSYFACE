...
sample_name = "C8_19F_Global_Length_-14.5-Fit-DOSY"
...
df_DOSY = import_data(r"C:\Users\bruno\Documents\Studium\MP_Kovermann\Processing\Global_Diff\Integrale-LB-var\C8_19F_global_G_Length_DOSY-150-165") #absolute path to dataH
...
Fitted_Curve = ["-80.69", "-118.86", "-121.51", "-121.88", "-122.56" , "-125.99"  ] # Fit Legend Beschriftung
...
ax.set_title("C8_19F_Length_Fit + Int.Std Contaminant")
...
save_dir = "Global_Diff/results/C8"
...
ax.set_title("C8_19F_Length Residuals + Int.Std Contaminant")
ax.set_xlabel("Gradient Length / s")
ax.set_ylabel("Norm. Integral / a.u.")
